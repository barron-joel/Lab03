...
author: "Joel, Aiman, User3, User4, User5, User6"
date: "`r Sys.Date()`"
...
There cannot be 1000+ billion speakers of chinese. The scaling of the charts are odd - chinese looks like it has twice as many as english. The fonts are weirds.
...
Unclear what variables are represented by what.
...
Rule of law is not a qualitative variable - cannot be on a numerical axis.
...
Wide data format has values that do no repeat in the first columns while long format do 
